"""
Django settings for testapiautosetting_136339 project.
...
ROOT_URLCONF = 'testapiautosetting_136339.urls'
...
WSGI_APPLICATION = 'testapiautosetting_136339.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "TestAPIAutoSettings6304a Support <support@testapiautosetting-136339.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testapiautosetting_136339 API",
    "DESCRIPTION": "API documentation for testapiautosetting_136339 App",
    "VERSION": "v1",
}
